                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-xl text-dark-600 leading-relaxed">
                                Centralized client, project, and task management
                                for small agencies. Get real-time insights,
                                comprehensive reporting, and role-based access
                                control.
                            </p>
                        </div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center space-x-2 text-sm">
                                            ...
                                            <span className="text-dark-600">
                                                New project created for Client A
                                            </span>
                                        </div>
                                        <div className="flex items-center space-x-2 text-sm">
