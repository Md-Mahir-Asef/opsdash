...
export const ProductDemo: React.FC = () => {
    const demoSteps = [
        {
            ...
            description:
                "Get a bird's eye view of your entire agency operations with real-time KPIs, project status, and team performance metrics.",
        ...
        },
        {
            ...
            description:
                "Create new projects, assign team members, set budgets and timelines, and track progress through customizable workflows.",
        ...
        },
        {
            ...
            description:
                "Efficiently assign tasks to team members, set priorities and due dates, and track completion status in real-time.",
        ...
        },
        {
            ...
            description:
                "Generate comprehensive reports with customizable filters, export to CSV/PDF, and schedule automated reports.",
        ...
        },
        {
            ...
            description:
                "Provide clients with secure access to view their projects, track progress, and communicate with your team.",
    ...
    return (
        <section
            id="demo"
            className="py-20 bg-gradient-to-br from-dark-100 to-dark-50"
        >
            <div className="container-max">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-dark-600 max-w-3xl mx-auto">
                        Experience how OpsDash transforms agency operations with
                        our interactive demo. Explore the key features that make
                        OpsDash the perfect solution for your agency.
                    </p>
                </div>
                                ...
                                <div className="aspect-video bg-dark-50 rounded-lg flex items-center justify-center border-2 border-dashed border-dark-300">
                                    <div className="text-center">
                                        ...
                                        <p className="text-dark-600 font-medium">
                                            Click to play interactive demo
                                        </p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-dark-600">
                                            Navigate through Admin, Staff, and
                                            Client dashboards
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-dark-600">
                                            See how live updates keep your team
                                            synchronized
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-dark-600">
                                            Access your agency operations from
                                            any device
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-dark-600">
                                            Generate and customize reports for
                                            stakeholders
                                        </p>
                                    </div>
                                </div>
